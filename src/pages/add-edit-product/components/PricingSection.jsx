      ...
      <div className="space-y-4">
        <Input
          label={
            <div className="flex items-center gap-2">
              Cost Price
              <HelpTooltip content="This is the total amount you paid to acquire one unit of this product." />
            </div>
          }
          type="number"
          placeholder="0.00"
        ...
        <Input
          label={
             <div className="flex items-center gap-2">
              Selling Price
              <HelpTooltip content="This is the price your customers will pay for one unit of this product. Make sure it's higher than the cost price to make a profit." />
            </div>
          }
          type="number"
          placeholder="0.00"
